...
sig_prop = np.sqrt(0.9*np.array([[0.5,0],[0,0.2]]))
a1 = time.time()
th_post, accept = stat_functions.HM_k(t0, log_post, kmax, pi_log=True, max_iter=2000, sigma_prop=sig_prop) #long time to execute ; prefer opening files from data bellow
